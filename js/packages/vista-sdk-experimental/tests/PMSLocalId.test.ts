...
import { DataId, PMSLocalIdBuilder } from "../lib";
import { PMSLocalId } from "../lib/PMSLocalId";
...
describe("LocalId", () => {
    ...
    it.each(testData)(
        ...
        async ({ input, output }) => {
            ...
            const localId = PMSLocalIdBuilder.create(visVersion)
    ...
    it.each(testData)(
        ...
        async ({ input }) => {
            ...
            let localId = PMSLocalIdBuilder.create(visVersion)
                .withPrimaryItem(primaryItem)
                .tryWithSecondaryItem(secondaryItem)
                .withVerboseMode(input.verbose)
                .tryWithMetadataTag(
