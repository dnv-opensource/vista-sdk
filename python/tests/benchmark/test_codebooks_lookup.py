...
from functools import lru_cache  # We'll use this to simulate frozen behavior
import pytest
...
class TestCodebooksLookup:
    ...
    def test_dict_lookup(self, benchmark: BenchmarkFixture, setup_codebooks) -> None:
        ...
        def dict_lookup() -> bool:
            result = (
                CodebookName.Quantity in dict_codebooks and
                CodebookName.Type in dict_codebooks and
                CodebookName.Detail in dict_codebooks
            )
            return result
    ...
    def test_frozen_dict_lookup(self, benchmark: BenchmarkFixture, setup_codebooks) -> None:
        ...
        def frozen_dict_lookup() -> bool:
            return all(
                ...
                for name in (CodebookName.Quantity, CodebookName.Type, CodebookName.Detail)
            )
    ...
    def test_codebooks_lookup(self, benchmark: BenchmarkFixture, setup_codebooks) -> None:
