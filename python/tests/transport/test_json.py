...
from vista_sdk.system_text_json import (
    ...
    DataChannelListContainer, ChannelList,
...
def test_data_channel_list_schema_validation(file_path):
    ...
    data2 = JsonSerializer.deserialize(json_str2, DataChannelListPackage)    # Compare objects
    assert data == data2
...
def test_data_channel_list_conversion():
    ...
    class MockPackage:
        def __init__(self):
            self.Header = MockHeader()
            self.DataChannelList = MockChannelList()
